...
$this->title = $model->id_jenis_surat;
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="jenis-surat-view">
                            <p>
                                <?= Html::a('<i class="fa fa-pencil"> </i> Update', ['update', 'id' => $model->id_jenis_surat], ['class' => 'btn btn-primary']) ?>
                                <?= Html::a('<i class="fa fa-trash"> </i> Delete', ['delete', 'id' => $model->id_jenis_surat], [
